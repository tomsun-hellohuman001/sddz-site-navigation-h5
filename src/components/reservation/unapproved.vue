  ...
  <div>
    ...
    <div class="m-content">
      <div style="margin-top: 80px">
        <h1 style="font-size: 50px;text-align: center">很抱歉</h1>
      </div>
      <div style="margin-top: 40px;padding: 20px">
        <h2 style="font-size: 25px;text-align: center">您未被许可进入</h2>
      </div>

      <div style="margin-top: 40px;padding: 20px">
        <h3 style="font-size: 20px;text-align: center">请联系相关业务经理</h3>
      </div>

    </div>
    <x-button @click.native="submitFrom" type="primary" :show-loading="submitLoading">确认</x-button>
